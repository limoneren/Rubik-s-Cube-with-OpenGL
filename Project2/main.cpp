...
GLfloat ViewerRotation[NumAxes] = {0.0, 0.0, 0.0}; // angle of viewer rotations ccw
GLfloat ViewerRotationCW[NumAxes] = {0.0, 0.0, 0.0}; // angle of viewer rotations cw
...
bool keyAPressed = false; // rotate cube around Y axis cw
bool keyDPressed = false; // rotate cube around Y axis ccw
bool keyWPressed = false; // rotate cube around X axis cw
bool keySPressed = false; // rotate cube around X axis ccw
...
bool lockForYView = false; // these locks are to solve an (off by one bug), to perfectly align the cube after each rotation
bool lockForYViewCW = false;
bool lockForXView = false;
bool lockForXViewCW = false;
...
display( void )
{
    ...
    for(int i = 0; i < 27; i++){
        ...
        if((int)ViewerRotationCW[Yaxis] % 90 == 0 && lockForYViewCW){
            ...
            if(i == 26){
                ...
                rightSide[0] = tempBackSide[2];
                rightSide[1] = tempBackSide[5];
                rightSide[2] = tempBackSide[8];
                rightSide[3] = tempBackSide[1];
                rightSide[4] = tempBackSide[4];
                rightSide[5] = tempBackSide[7];
                rightSide[6] = tempBackSide[0];
                rightSide[7] = tempBackSide[3];
                rightSide[8] = tempBackSide[6];
                
                backSide[0] = tempLeftSide[0];
                backSide[1] = tempLeftSide[3];
                backSide[2] = tempLeftSide[6];
                backSide[3] = tempLeftSide[1];
                backSide[4] = tempLeftSide[4];
                backSide[5] = tempLeftSide[7];
                backSide[6] = tempLeftSide[2];
                backSide[7] = tempLeftSide[5];
                backSide[8] = tempLeftSide[8];
                
                leftSide[0] = tempFrontSide[2];
                leftSide[1] = tempFrontSide[5];
                leftSide[2] = tempFrontSide[8];
                leftSide[3] = tempFrontSide[1];
                leftSide[4] = tempFrontSide[4];
                leftSide[5] = tempFrontSide[7];
                leftSide[6] = tempFrontSide[0];
                leftSide[7] = tempFrontSide[3];
                leftSide[8] = tempFrontSide[6];
                
                frontSide[0] = tempRightSide[0];
                frontSide[1] = tempRightSide[3];
                frontSide[2] = tempRightSide[6];
                frontSide[3] = tempRightSide[1];
                frontSide[4] = tempRightSide[4];
                frontSide[5] = tempRightSide[7];
                frontSide[6] = tempRightSide[2];
                frontSide[7] = tempRightSide[5];
                frontSide[8] = tempRightSide[8];
                ...
                bottomSide[0] = tempBottomSide[2];
                bottomSide[1] = tempBottomSide[5];
                bottomSide[2] = tempBottomSide[8];
                bottomSide[3] = tempBottomSide[1];
                bottomSide[4] = tempBottomSide[4];
                bottomSide[5] = tempBottomSide[7];
                bottomSide[6] = tempBottomSide[0];
                bottomSide[7] = tempBottomSide[3];
                bottomSide[8] = tempBottomSide[6];
                
                lockForYViewCW = false;
                anotherKeyIsActive = false;
        ...
        if((int)ViewerRotationCW[Xaxis] % 90 == 0 && lockForXViewCW){
            ...
            if(i == 26){
                ...
                backSide[0] = tempTopSide[0];
                backSide[1] = tempTopSide[1];
                backSide[2] = tempTopSide[2];
                backSide[3] = tempTopSide[3];
                backSide[4] = tempTopSide[4];
                backSide[5] = tempTopSide[5];
                backSide[6] = tempTopSide[6];
                backSide[7] = tempTopSide[7];
                backSide[8] = tempTopSide[8];
                
                leftSide[0] = tempLeftSide[2];
                leftSide[1] = tempLeftSide[5];
                leftSide[2] = tempLeftSide[8];
                leftSide[3] = tempLeftSide[1];
                leftSide[4] = tempLeftSide[4];
                leftSide[5] = tempLeftSide[7];
                leftSide[6] = tempLeftSide[0];
                leftSide[7] = tempLeftSide[3];
                leftSide[8] = tempLeftSide[6];
                
                frontSide[0] = tempBottomSide[0];
                frontSide[1] = tempBottomSide[1];
                frontSide[2] = tempBottomSide[2];
                frontSide[3] = tempBottomSide[3];
                frontSide[4] = tempBottomSide[4];
                frontSide[5] = tempBottomSide[5];
                frontSide[6] = tempBottomSide[6];
                frontSide[7] = tempBottomSide[7];
                frontSide[8] = tempBottomSide[8];
                
                topSide[0] = tempFrontSide[6];
                topSide[1] = tempFrontSide[7];
                topSide[2] = tempFrontSide[8];
                topSide[3] = tempFrontSide[3];
                topSide[4] = tempFrontSide[4];
                topSide[5] = tempFrontSide[5];
                topSide[6] = tempFrontSide[0];
                topSide[7] = tempFrontSide[1];
                topSide[8] = tempFrontSide[2];
                
                bottomSide[0] = tempBackSide[6];
                bottomSide[1] = tempBackSide[7];
                bottomSide[2] = tempBackSide[8];
                bottomSide[3] = tempBackSide[3];
                bottomSide[4] = tempBackSide[4];
                bottomSide[5] = tempBackSide[5];
                bottomSide[6] = tempBackSide[0];
                bottomSide[7] = tempBackSide[1];
                bottomSide[8] = tempBackSide[2];
                
                lockForXViewCW = false;
                anotherKeyIsActive = false;
...
idle( void )
{
    ...
    if(keyAPressed && ((int)ViewerRotationCW[Yaxis] % 90 != 0)){
        lockForYViewCW = true;
        ViewerRotationCW[Yaxis] -= 1.0;
        
        if ( ViewerRotationCW[Yaxis] <= -360.0 ) {
            ViewerRotationCW[Yaxis] += 360.0;
        }
        
        if(((int)ViewerRotationCW[Yaxis] % 90 == 0)){
            keyAPressed = false;
            lockForYViewCW = true;
        }
    }
    
    if(keyDPressed && ((int)ViewerRotation[Yaxis] % 90 != 0)){
        lockForYView = true;
    ...
    if(keySPressed && ((int)ViewerRotation[Xaxis] % 90 != 0)){
        lockForXView = true;
    ...
    if(keyWPressed && ((int)ViewerRotationCW[Xaxis] % 90 != 0)){
        lockForXViewCW = true;
        ViewerRotationCW[Xaxis] -= 1.0;
        
        if ( ViewerRotationCW[Xaxis] <= -360.0 ) {
            ViewerRotationCW[Xaxis] += 360.0;
        }
        
        if(((int)ViewerRotationCW[Xaxis] % 90 == 0)){
            keyWPressed = false;
            lockForXViewCW = true;
        }
...
keyboard( unsigned char key,int x, int y )
{
    if(key == 'Q' | key == 'q')
    ...
    else if(key == 'A' | key == 'a'){ // rotate cube around Y axis cw
    ...
    else if(key == 'D' | key == 'd'){ // rotate cube around Y axis ccw
    ...
    else if(key == 'W' | key == 'w'){ // rotate cube around X axis cw
    ...
    else if(key == 'S' | key == 's'){ // // rotate cube around X axis ccw
        ...
        std::cout << "M\tRandomize the Cube!" << std::endl;
        std::cout << "W\tRotate the Cube around X Axis cw" << std::endl;
        std::cout << "A\tRotate the Cube around Y Axis cw" << std::endl;
        std::cout << "S\tRotate the Cube around X Axis ccw" << std::endl;
        std::cout << "D\tRotate the Cube around Y Axis ccw" << std::endl;
        std::cout << "Right Click on a Face\tRotate that face cw" << std::endl;
        std::cout << "Left Click on a Face\tRotate that face ccw" << std::endl;
...
void timer( int p )
{
    ...
    if(seq != 9){
        ...
        secs = 9;
        if(check){
            std::cout << "Randomization Finished. Go!" << std::endl;
            check = false;
        }
    }
    if(secs % 2 == 0){
        ...
        int randNum = rand() % 4;
            ...
            if(randNum == 0){
                ...
                if(!anotherKeyIsActive){ // button F
                    anotherKeyIsActive = true;
                    Theta[Zaxis] += 1.0;
                    keyFPressed = true;
                }
                ...
                if(!anotherKeyIsActive){ // button T
                    anotherKeyIsActive = true;
                    Theta[Yaxis] += 1.0;
                    keyTPressed = true;
                }
...
main( int argc, char **argv )
{
    ...
    std::cout << "Press H to learn how to play!" << std::endl;
